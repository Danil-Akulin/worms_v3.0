...
namespace MinuVorm
{
    public partial class MyForm : Form
    {
        ...
        {
            string text = "Sinu ost on Akulin \n";
            foreach (var item in piletid)
            {
                text += "Tere ma olen Robot\n " + " Pilet: " + " Rida: " + item.Rida + " Koht: " + item.Koht + 
                    " Head filmi vaatamist " + Kino1 +
                    " Kui külastate meie kinosaali kingituseks, saate тушканьчика" + "\n";
            }
